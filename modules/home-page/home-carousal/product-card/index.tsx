...
} from "@/modules/home-page/home-carousal/product-card/styles";
import { ProductCardProps } from "@/modules/home-page/home-carousal/product-card/types";
  ...
  return (
    <div css={[productCardContainerCss, extraStyles]} className={name}>
      ...
      <div css={productCardTextWrapperCss}>
        ...
        <LinkCtaBtn link={`product/${cardHeading.replace(/ /g, "-")}`} extraStyles={productCardBtnCss}>
          {cardCtaText}
        </LinkCtaBtn>
      </div>
    </div>
